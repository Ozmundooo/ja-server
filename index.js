...
app.get("/ontario", (req, res) => {
  ...
  axios
    .get(
      `${process.env.API_DOMAIN}/listings?city=${city}&pageNum=${pageNum}&resultsPerPage=${resultsPerPage}&sortBy=${sortBy}${additionalQuery}`,
      {
        headers: {
          "REPLIERS-API-KEY": `${process.env.API_KEY}`,
        },
...
app.get("/florida", (req, res) => {
  let city = "Fort+Myers&city=gma&city=orlando&city=tampa";
  let pageNum = req.query.pageNum;
  let resultsPerPage = req.query.resultsPerPage;
  let sortBy = req.query.sortBy;
  let mlsNumber = req.query.mlsNumber;
...
app.get("/:mlslisting/:boardId", (req, res) => {
  axios
    .get(
      `${process.env.API_DOMAIN}/listings/${req.params.mlslisting}?boardId=${req.params.boardId}`,
      {
        headers: {
          "REPLIERS-API-KEY": `${process.env.API_KEY}`,
        },
